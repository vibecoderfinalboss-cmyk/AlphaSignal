...
export const NICHES = [
  { id: "defi", label: "DeFi", emoji: "\u{1F3E6}", color: palette.orange },
  { id: "rwa", label: "RWA", emoji: "\u{1F3E2}", color: palette.blue },
  { id: "ai", label: "AI / DePAI", emoji: "\u{1F916}", color: palette.purple },
  { id: "l1l2", label: "L1 / L2", emoji: "\u{26D3}\uFE0F", color: palette.cyan },
  { id: "btc", label: "Bitcoin", emoji: "\u20BF", color: palette.yellow },
  { id: "memes", label: "Memes", emoji: "\u{1F438}", color: palette.lime },
];
...
export const TONES = [
  {
    ...
    label: "Degen",
    emoji: "\u{1F919}",
    example: "Ser if you're not farming this, ngmi.",
    color: palette.pink,
  },
  {
    id: "pro",
    label: "Professional",
    emoji: "\u{1F4CA}",
    example: "The risk-adjusted opportunity here is underpriced.",
    color: palette.blue,
  },
  {
    id: "edu",
    label: "Educational",
    emoji: "\u{1F4DA}",
    example: "Let me break down why this matters.",
    color: palette.green,
  },
];

export const CHAINS = [
  { id: "eth", label: "Ethereum", emoji: "\u27E0", color: palette.blue },
  { id: "base", label: "Base", emoji: "\u{1F535}", color: palette.cyan },
  { id: "megaeth", label: "MegaETH", emoji: "\u26A1", color: palette.yellow },
  { id: "monad", label: "Monad", emoji: "\u{1F7E3}", color: palette.purple },
  { id: "arb", label: "Arbitrum", emoji: "\u{1F537}", color: palette.blue },
  { id: "zksync", label: "zkSync", emoji: "\u{1F532}", color: palette.pink },
];

export const CONTENT_MISSIONS = [
  {
    id: "c1",
    type: "Hot Take",
    niche: "DeFi",
    ...
    emoji: "\u{1F525}",
    tweet:
      'Unpopular opinion: most "DeFi protocols" shipping in 2026 are just TradFi with extra steps.\n\nThe ones that survive will be the ones banks literally cannot replicate \u2014 permissionless composability, not just "on-chain settlement."\n\nName one protocol that passes this test. \u{1F447}',
    rationale:
      "Contrarian frames drive replies. Question hook invites engagement.",
    source: {
      headline: "DeFi TVL hits $180B while institutional adoption stalls",
      publisher: "The Block",
      url: "https://theblock.co",
      time: "3h ago",
      summary:
        "Total value locked across DeFi has reached $180B ATH, driven by liquid staking and restaking. However, institutional adoption has flatlined \u2014 fewer than a dozen TradFi managers deployed meaningful capital on-chain. 73% of new protocols launched with KYC features. Permissionless protocols growing 2.4x faster.",
      dataPoints: [
        "$180B total DeFi TVL \u2014 new ATH",
        "Only $3.2B from institutions (1.8%)",
        "73% new protocols include KYC",
        "Permissionless growing 2.4x faster",
      ],
      nuggets: [
        '73% of new DeFi protocols launched with KYC gates \u2014 at what point do we stop calling it DeFi?',
        '$180B TVL but only $3.2B from institutions. The "institutional adoption" narrative is dead.',
      ],
    },
    alts: [
  ...
  },
  {
    ...
    emoji: "\u{1F48E}",
    tweet:
      "Everyone is watching the AI agent meta.\n\nAlmost nobody is watching who controls the compute layer underneath.\n\nThree protocols are quietly building the AWS of decentralized AI.\n\nBookmark this. \u{1F9F5}\u{1F447}",
    rationale:
      '"Bookmark this" targets highest-weight algorithm signal.',
    source: {
      headline: "Decentralized compute demand surges 340% in Q1",
      publisher: "Messari",
      url: "https://messari.io",
      time: "5h ago",
      summary:
        "Demand for decentralized GPU compute surged 340% QoQ, outpacing supply growth of 89%. Three leaders: Render Network ($2.1B staked), Akash (14K+ providers), io.net (28K GPU hours/day). Decentralized inference now 62% cheaper than AWS.",
      dataPoints: [
        "Compute demand: +340% QoQ",
        "Supply: only +89%",
        "Render: $2.1B staked",
        "62% cheaper than AWS",
      ],
      nuggets: [
        "340% demand vs 89% supply. GPU shortage is real \u2014 bullish for infra tokens.",
        "Decentralized AI inference is 62% cheaper than AWS. Literally cheaper AND permissionless.",
      ],
    },
    alts: [
  ...
  },
  {
    ...
    emoji: "\u26A1",
    tweet:
      "If you're not testing @[redacted] on testnet right now, you'll be complaining about \"unfair criteria\" in 6 months.\n\n5 minutes today > 5 hours of cope later.",
    rationale: "Urgency + specific action. Classic CT engagement.",
    source: {
      headline: "New L2 opens testnet with $40M airdrop allocation",
      publisher: "Decrypt",
      url: "https://decrypt.co",
      time: "7h ago",
      summary:
        "ZK-rollup L2 backed by $120M (a16z + Paradigm) opened public testnet. 8% of supply for participants. 5 txns across 3 types = eligible. Zero capital. 90-day testnet.",
      dataPoints: [
        "$120M Series B",
        "8% supply for airdrop",
        "5 txns = eligible",
        "Zero capital required",
      ],
      nuggets: [
        "8% token supply for testnet users. 5 transactions. Most obvious airdrop of 2026.",
        "Zero capital risk, 5 min effort, $120M backing. Risk/reward is absurd.",
      ],
    },
    alts: [
...
export const FARM_TASKS = [
  {
    ...
    emoji: "\u26A1",
    disclaimer:
      "Tasks based on MegaETH's official testnet announcement. Eligibility determined by MegaETH, not Alpha Signal.",
  ...
  },
  {
    ...
    emoji: "\u{1F7E3}",
    disclaimer:
      "Tasks based on Monad's official testnet program. Past airdrops don't guarantee future results.",
  ...
  },
  {
    ...
    emoji: "\u{1F534}",
    disclaimer:
      "LayerZero S2 criteria based on official announcement. Subject to change.",
...
export const LEVELS = [
  { name: "Lurker", min: 0, color: "#9CA3AF", icon: "\u{1F440}" },
  { name: "Contributor", min: 200, color: palette.blue, icon: "\u270D\uFE0F" },
  { name: "Voice", min: 600, color: palette.purple, icon: "\u{1F5E3}\uFE0F" },
  { name: "Analyst", min: 1500, color: palette.orange, icon: "\u{1F4CA}" },
  { name: "Alpha Leader", min: 3500, color: palette.pink, icon: "\u{1F451}" },
  { name: "CT Legend", min: 7000, color: palette.red, icon: "\u{1F3C6}" },
];
